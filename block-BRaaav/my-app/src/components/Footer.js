          ...
          <div className="flex align-start">
            ...
            <div className="flex-20">
              ...
              <nav>
                <ul>
                  <li>
                    <a href="asdsfdgfhg">About us</a>
                  </li>
                  <li>
                    <a href="asdsfdgfhg">Join our team</a>
                  </li>
                  <li>
                    <a href="asdsfdgfhg">Read blog</a>
                  </li>
                  <li>
                    <a href="asdsfdgfhg">Press</a>
                  </li>
                </ul>
              </nav>
            </div>
            <div className="flex-20">
              ...
              <nav>
                <ul>
                  <li>
                    <a href="asdsfdgfhg">Pricing</a>
                  </li>
                  <li>
                    <a href="asdsfdgfhg">Documentation</a>
                  </li>
                  <li>
                    <a href="asdsfdgfhg">Support</a>
                  </li>
                </ul>
              </nav>
            </div>
